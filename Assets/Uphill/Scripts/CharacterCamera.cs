...
namespace Assets.Uphill.Scripts
{
    public class CharacterCamera : MonoBehaviour
    {
        ...
        [Range(-90f, 90f)]
        public float DefaultHorizontalAngle = 20f;
        [Range(-90f, 90f)]
        ...
        void OnValidate()
        {
            ...
            DefaultHorizontalAngle = Mathf.Clamp(DefaultHorizontalAngle, MinHorizontalAngle, MaxHorizontalAngle);
        }
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            if (FollowTransform)
            {
                ...
                _targetHorizontalAngle = Mathf.Clamp(_targetHorizontalAngle, MinHorizontalAngle, MaxHorizontalAngle);

                Quaternion verticalRot = Quaternion.Euler(_targetVerticalAngle, 0, 0);
                Quaternion horizontalRot = Quaternion.Euler(0, _targetHorizontalAngle, 0);

                Quaternion targetRotation = Quaternion.Slerp(Transform.rotation, horizontalRot * verticalRot, 1f - Mathf.Exp(-RotationSharpness * deltaTime));
